...
const QString DLLName("HSWidgetxSchumi1331AppList_A1331002_rel.dll");
...
protected:
    explicit QHSWidget(QString templateType, QString widgetName, QString widgetId,
                       QString widgetDesc = "", QString widgetIcon = "", QObject *parent = 0): QObject(parent)
    {
    }
...
public:
    ...
    virtual void RemoveItem(QString itemName) = 0;
...
public:
    typedef QHSWidget* (*createHSWidget)(QString, QString, QString, QString, QString, QObject*);

    static QHSWidget* create(QString templateType, QString widgetName, QString widgetId,
                             QString widgetDesc, QString widgetIcon, QObject *parent = 0)
    {
        ...
        if (lib.load())
        {
            ...
            if (func)
            {
                QHSWidget* widget = func(templateType, widgetName, widgetId, widgetDesc, widgetIcon, parent);
                if (widget)
                {
